      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-white/90 backdrop-blur-xl p-6 rounded-2xl shadow-2xl relative z-10 w-full max-w-lg overflow-hidden"
          >
            <button 
              onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <input
                ...
                className="w-full px-4 py-3.5 rounded-xl bg-gray-50 border border-gray-200 focus:border-orange-300 focus:bg-white focus:ring-2 focus:ring-orange-100 text-gray-800 text-base transition-all duration-200 outline-none placeholder:text-gray-400 font-medium"
              />
              <div className="flex justify-end gap-3 mt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-2.5 text-gray-500 hover:bg-gray-100 rounded-xl font-medium transition-colors focus:outline-none"
                >
                  Cancel
                </button>
                <button 
