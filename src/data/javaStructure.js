// Java Programming Topic Structure
export function getJavaStructure() {
  return [
    { group: "START HERE", items: ["00-java-roadmap"] },
    {
      group: "Programming Basics & Foundations",
      items: [
        "01-what-is-program",
    ...
    {
      group: "Java Introduction & History",
      items: [
    ...
    {
      group: "Java Editions & Platform Independence",
      items: [
        "12-java-editions",
    ...
    {
      group: "Java Architecture & JVM Internals",
      items: [
        "17-jdk",
        "18-jre",
        "19-jvm",
    ...
    {
      group: "Comments & Coding Standards",
      items: [
        "31-comments",
    ...
    {
      group: "Type Conversion & Encoding",
      items: ["41-ascii-vs-unicode", "42-type-casting", "43-type-promotion"],
    },
    {
      group: "Operators in Java",
      items: [
    ...
    {
      group: "Memory Management & JVM Lifecycle",
      items: [
        "91-stack-memory",
        "92-heap-memory",
        "93-references",
    ...
    {
      group: "Performance & Career",
      items: [
        "110-performance-tips",
        "111-java-roadmap",
        "112-interview-prep",
        "113-quick-reference",
        "114-java-interview-questions",
      ],
    },
  ];
}
