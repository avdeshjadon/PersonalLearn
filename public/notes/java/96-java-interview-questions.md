...
Some features include Object Oriented, Platform Independent, Robust, and Interpreted, Multi-threaded
...
Default value of float and double data type in different as compared to C/C++. For float its 0.0f and for double its 0.0d
