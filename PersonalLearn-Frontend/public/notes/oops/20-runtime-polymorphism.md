...
║    ║                    ALSO KNOWN AS                                       ║    ║
║    ║                                                                        ║    ║
║    ║   • Dynamic Polymorphism   • Late Binding    • Method Overriding       ║    ║
║    ║                                                                        ║    ║
║    ╚════════════════════════════════════════════════════════════════════════╝    ║
║                                                                                  ║
╠══════════════════════════════════════════════════════════════════════════════════╣
...
║   ║ Does Animal have  ║                         ║  Actual object    ║            ║
║   ║ sound() method?   ║                         ║  is Dog           ║            ║
║   ║      ✓ Yes        ║                         ║                   ║            ║
║   ╚═══════════════════╝                         ╚═══════════════════╝            ║
║           │                                                 │                    ║
...
║              ╔═══════════════════════════════════════════════╗                   ║
║              ║          RUNTIME DECISION                     ║                   ║
║              ║   JVM uses OBJECT TYPE (Dog) to decide        ║                   ║
║              ║   which sound() method to call                ║                   ║
║              ╚═══════════════════════════════════════════════╝                   ║
║                                    │                                             ║
║                                    ▼                                             ║
║              ╔═══════════════════════════════════════════════╗                   ║
║              ║      Dog's sound() method executes            ║                   ║
...
║   ║ void sound() {      ║ ║ void sound() {      ║ ║ void sound() {      ║        ║
║   ║   "Woof Woof"       ║ ║   "Meow Meow"       ║ ║   "Moo Moo"         ║        ║
║   ║ }                   ║ ║ }                   ║ ║ }                   ║        ║
║   ╚═════════════════════╝ ╚═════════════════════╝ ╚═════════════════════╝        ║
║                                                                                  ║
║   Animal a1 = new Dog();   Animal a2 = new Cat();   Animal a3 = new Cow();       ║
║   a1.sound(); → Woof       a2.sound(); → Meow       a3.sound(); → Moo            ║
║                                                                                  ║
╠══════════════════════════════════════════════════════════════════════════════════╣
║                      UPCASTING AND DOWNCASTING                                   ║
╠══════════════════════════════════════════════════════════════════════════════════╣
...
║   ╠═══════════════════════════════════════════════════════════════════════╣      ║
║   ║                                                                       ║      ║
║   ║   Animal animal = new Dog();     // Automatic, Safe ✓                 ║      ║
║   ║                                                                       ║      ║
║   ║   ┌─────────────┐         ┌─────────────┐                             ║      ║
║   ║   │   Animal    │ <────── │    Dog      │                             ║      ║
║   ║   │ (Reference) │         │  (Object)   │                             ║      ║
...
║   ║                                                                       ║      ║
║   ║   ⚠️  Use instanceof before downcasting:                              ║      ║
║   ║   if (animal instanceof Dog) {                                        ║      ║
...
║   ╠═══════════════════════════════════════════════════════════════════════╣      ║
║   ║                           │                                           ║      ║
║   ║  • Instance methods       │  • static methods (hidden instead)        ║      ║
║   ║  • protected methods      │  • final methods                          ║      ║
║   ║  • public methods         │  • private methods (not inherited)        ║      ║
