...
║   ║      ❌ BAD                              ✓ GOOD                               ║   ║
║   ║      ┌─────────────────┐                 ┌───────────────┐                    ║   ║
║   ║      │ PaymentProcessor│                 │  <<Payment>>  │ ← Interface       ║   ║
║   ║      ├─────────────────┤                 └───────┬───────┘                    ║   ║
║   ║      │ if(credit card) │                         │                            ║   ║
║   ║      │ if(paypal)      │     ────►     ┌─────────┼─────────┐                  ║   ║
║   ║      │ if(bitcoin)     │               │         │         │                  ║   ║
...
║   ║  ═══════════════════════════════════════════════════════════════════════════  ║   ║
║   ║                                                                               ║   ║
║   ║      "Subclass should be SUBSTITUTABLE for its parent class"                  ║   ║
║   ║                                                                               ║   ║
║   ║      ❌ BAD                              ✓ GOOD                               ║   ║
║   ║      ┌─────────────────┐                 ┌─────────────────┐                  ║   ║
║   ║      │      Bird       │                 │      Bird       │                  ║   ║
...
║   ║         ▼           ▼                       ▼           ▼                     ║   ║
║   ║    ┌─────────┐ ┌─────────┐             ┌─────────┐ ┌─────────┐                ║   ║
║   ║    │ Sparrow │ │ Penguin │             │ FlyBird │ │WalkBird │                ║   ║
║   ║    │ fly() ✓ │ │ fly() ✗ │             │ fly()   │ │ walk()  │                ║   ║
║   ║    └─────────┘ └─────────┘             └─────────┘ └─────────┘                ║   ║
║   ║                  ↑ Breaks!                                                    ║   ║
║   ║                                                                               ║   ║
...
║   ║        DRY          ║  ║        KISS         ║  ║       YAGNI         ║           ║
║   ║  ═══════════════    ║  ║  ═══════════════    ║  ║  ═══════════════    ║           ║
║   ║  Don't Repeat       ║  ║  Keep It Simple,    ║  ║  You Aren't Gonna   ║           ║
║   ║  Yourself           ║  ║  Stupid             ║  ║  Need It            ║           ║
║   ║                     ║  ║                     ║  ║                     ║           ║
║   ║  ❌ Copy-paste      ║  ║  ❌ Over-engineer   ║  ║  ❌ "Just in case"  ║           ║
║   ║  ✓ Extract method   ║  ║  ✓ Simple solution  ║  ║  ✓ Add when needed  ║           ║
║   ║                     ║  ║                     ║  ║                     ║           ║
║   ╚═════════════════════╝  ╚═════════════════════╝  ╚═════════════════════╝           ║
║                                                                                       ║
║   ┌─────────────────────────────────────────────────────────────────────────────────┐ ║
...
║                                                                                       ║
║      ┌────────────┐   ┌────────────┐   ┌────────────┐   ┌────────────┐                ║
║      │Maintainable│   │  Testable  │   │  Flexible  │   │  Scalable  │                ║
║      │            │   │            │   │            │   │            │                ║
║      │ Easy to    │   │ Unit test  │   │ Easy to    │   │ Grows with │                ║
║      │ modify     │   │ friendly   │   │ extend     │   │ project    │                ║
║      └────────────┘   └────────────┘   └────────────┘   └────────────┘                ║
║                                                                                       ║
╚═══════════════════════════════════════════════════════════════════════════════════════╝
```
