...
Jab hdddddddddddum program mein ek data type ki value ko kisi doosre data type ke variable mein assign karte hain, toh use **Type Conversion** ya **Type Casting** kehte hain.
...
_(Note: Agar aap byte result = a + b; likhoge toh error aayega kyunki a+b ka result int hota hai!)_
